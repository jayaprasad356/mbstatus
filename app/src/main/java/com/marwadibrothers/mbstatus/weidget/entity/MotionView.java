package com.marwadibrothers.mbstatus.weidget.entity;
...
import com.marwadibrothers.mbstatus.weidget.multitouch.MoveGestureDetector;
import com.marwadibrothers.mbstatus.weidget.multitouch.RotateGestureDetector;
...
public class MotionView extends FrameLayout {
    ...
    private void initEntityBorder(@NonNull MotionEntity entity) {
        ...
        borderPaint.setColor(ContextCompat.getColor(getContext(), R.color.black_de));
    ...
    public void deletedSelectedEntity(MotionEntity motionEntity) {
        if (motionEntity == null) {
            return;
        }
        if (entities.remove(motionEntity)) {
