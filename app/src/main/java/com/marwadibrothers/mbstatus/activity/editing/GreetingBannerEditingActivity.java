...
import com.marwadibrothers.mbstatus.databinding.ActivityGreetingBannerEditingBinding;
...
import com.marwadibrothers.mbstatus.weidget.flexibleImageview.ImageviewTouch;
import com.marwadibrothers.mbstatus.weidget.stickerview.view.BubbleInputDialog;
import com.marwadibrothers.mbstatus.weidget.stickerview.view.BubbleTextView;
import com.marwadibrothers.mbstatus.weidget.stickerview.view.StickerView;
...
public class GreetingBannerEditingActivity extends AppCompatActivity implements TextEditorDialogFragment.OnTextLayerCallback {
    ActivityGreetingBannerEditingBinding binding;
    ...
    private StickerView GallerystickerView;
...
//    public InterstitialAdListener interstitialAdListener;
    ...
    public static GreetingBannerEditingActivity instance = null;

    public GreetingBannerEditingActivity() {
        instance = GreetingBannerEditingActivity.this;
    }

    public static synchronized GreetingBannerEditingActivity getInstance() {
        if (instance == null) {
            instance = new GreetingBannerEditingActivity();
        }
        return instance;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_greeting_banner_editing);
        dialog = new Dialog(context);
        downloadDialog = new Dialog(context);
        subCatID = getIntent().getStringExtra(Config.SUB_CAT_ID_1);
        ...
        binding.toolbarSupport.ivhide.setVisibility(View.GONE);
...
//        initAD();
        ...
        binding.ivfooterLogo.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                viewTransformation(binding.llBanner, event);
...
//        binding.vpPersonalFrame.setVisibility(View.VISIBLE);
    ...
    private void initviews() {
        ...
        DataLooping();
        binding.ivfooterLogo.setOnTouchListener(new ImageviewTouch());
        mViews = new ArrayList<>();
        if (Helper.checkInternet(context)) {
            MyProfile();
        }

        GallerystickerView = new StickerView(this);
...
//            binding.toolbarSupport.llShare.setVisibility(View.VISIBLE);
            ...
            binding.toolbarSupport.ivhide.setVisibility(View.VISIBLE);
...
//                diplayFacebookad();
               /* if(comeFrom.equals("save")||comeFrom.equals("Share")){
                ...
                fullADInit(GreetingBannerEditingActivity.this);
        ...
        RewardedAd.load(context, getString(R.string.rewarded_ads),
                adRequest, new RewardedAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                        ...
                        Log.d("klcxck", "loaded-=-=-=->>>>>" + "Ad was loaded.");
                    }
...
//                    downloadDialog.dismiss();
                ...
                public void onAdDismissedFullScreenContent() {
                    ...
                    Log.d("klcxck", "failed-=-=-=->>>>>" + "Ad was dismissed.");
                    /*downloadDialog.dismiss();
                    MainActivity.instance.StartTimer();
                    if (comeFrom.equals("save") || comeFrom.equals("Share")) {
                        download();
            ...
            Log.d("klcxck", "else-=-=-=->>>>>" + "The rewarded ad wasn't ready yet.");
        }
...
//                                new SharedPreferencesHelper(context).setString(Config.USER_ID, jsonObject.getJSONObject("data").getString("user_id"));
    ...
    private void AddBackgroundIMage(Bitmap bitmap) {
        ...
        stickerView.setOperationListener(new StickerView.OperationListener() {
            ...
            public void onDeleteClick() {
                ...
                binding.backMotionView2.removeView(stickerView);
            }
        ...
        binding.backMotionView2.addView(stickerView, lp);
        mViews.add(stickerView);
        setCurrentEdit(stickerView);
    }

    private void AddBackgroundIMage2(Bitmap bitmap) {
        binding.vpPersonalFrame.setVisibility(View.GONE);
        binding.vpFrame.setVisibility(View.GONE);

        GallerystickerView.setBitmap(bitmap);
        GallerystickerView.setOperationListener(new StickerView.OperationListener() {
            @Override
            public void onDeleteClick() {
                Log.d("sdsdjsdjs", "2");

                mViews.remove(GallerystickerView);
                binding.backMotionView2.removeView(GallerystickerView);
            }
        ...
        RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT);
        binding.backMotionView2.addView(GallerystickerView, lp);
        mViews.add(GallerystickerView);
        setCurrentEdit(GallerystickerView);

    }

    private void AddText() {
        final BubbleTextView bubbleTextView = new BubbleTextView(this, Color.BLACK, 0);
        bubbleTextView.setImageResource(R.drawable.bordertext);
        bubbleTextView.setOperationListener(new BubbleTextView.OperationListener() {
            @Override
            public void onDeleteClick() {
                mViews.remove(bubbleTextView);
                binding.backMotionView3.removeView(bubbleTextView);
            }
        ...
        RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT);
        binding.backMotionView3.addView(bubbleTextView, lp);
        if (mViews != null)
    ...
    private void AddingBanner() {
        ...
        Glide.with(context).load(getIntent().getStringExtra(Config.IMAGE_URL)).into(binding.ivBanner);
//        AddText();
        Glide.with(context)
                .asBitmap()
                .load(getIntent().getStringExtra(Config.FORGROUND_IMAGE))
                .into(new CustomTarget<Bitmap>() {
                    @Override
                    public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                        AddBackgroundIMage(resource);
                    }
    ...
    private void ClickEvent() {
        ...
        binding.backMotionView2.setOnClickListener(v -> {
            Log.d("dsdhsds", "dhsdhdhh");
            HideBoarder();
        });
...
/*
        ...
        binding.toolbarSupport.ivhide.setOnClickListener(v -> {
            HideBoarder();
        });
    }
    ...
    private void GetProductData() {
        Helper.Show_loader(context, false, false);
        RequestBody sub_category_id = RequestBody.create(subCatID, MediaType.parse("text/plain"));
    ...
    private void ChangeTextEntityFont() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setAdapter(fontsAdapter, (dialogInterface, which) -> {
                    mCurrentEditTextView.setTextStyle(fonts.get(which), fontProvider);
                })
                .show();
    }
    ...
    private void changeTextEntityColor() {
        ...
        ColorPickerDialogBuilder
                ...
                .setPositiveButton(R.string.ok, (dialog, selectedColor, allColors) -> {
                    mCurrentEditTextView.setTextColor(selectedColor);
...
//        binding.Footer4.txtAddress.setTextColor(selectedColor);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                AddBackgroundIMage2(resultBitmap);
    ...
    private void HandlePopulateData(Response<MyProfileResponse> response) {
        ...
        FramePersonalSliderAdepter framePersonalSliderAdepter = new FramePersonalSliderAdepter(context, imgarrayList, responseData, "greetingEdit");
        ...
        AllFillTagRemove();
        RemoveAllFooter();
        Log.d("fjjsfjsdjfj", "fjfjdij" + model);
        if (model != null) {
            FrameSliderAdepter frameSliderAdepter = new FrameSliderAdepter(context, imgarrayList, model, "greetingEdit");
